...
namespace TimerUtility
{
    ...
    *  Description:        Timer which has several Actions that can be used to trigger events throughout the timers lifecycle
    *  Revision History:   November 12th (Liam Nelski): Inital Script.
    *                      November 13th (Liam Nelski): Added Option Callback for onTick
    *                      2022 November 21st (Liam Nelski): Added Support for Canceling, Pausing and Updating the Timer
    *                      2023 April 16th (Liam Nelski): Removed 'Timer' from funtion name as it is redunent
    *                      2023 April 17th (Liam Nelski): Added Set and Add functions to the Complete and TickCallbacks, removed assignment from start function
    *                      2024 Feburary 13th (Liam Nelski): Added to TimerUtility namespace to move to unity package
    *                      
    *                      
    *                      
    * Version: 1.0.2                      
